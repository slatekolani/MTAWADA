    ...
    <div class="container">
        <div class="cta-content" style="text-align: center; max-width: 800px; margin: 0 auto; position: relative; z-index: 2;">
            ...
            <p style="font-size: 18px; color: rgba(255, 255, 255, 0.9); margin-bottom: 40px; line-height: 1.7;">
                Are you a waste picker in Dar es Salaam? Join over 850 members fighting for recognition, fair treatment,
                and environmental sustainability. Together, we can build a stronger voice for waste pickers' rights.
            </p>
            <div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
                <a href="{{route('mtawada.contact')}}" class="btn-primary" style="background: #FFC107; color: #333333; padding: 16px 40px; border-radius: 30px; text-decoration: none; font-weight: 600; display: inline-flex; align-items: center; gap: 12px; transition: all 0.3s;">
