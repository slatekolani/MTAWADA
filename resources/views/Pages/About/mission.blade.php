    ...
    <div class="container" style="position: relative; z-index: 3; min-height: 500px; display: flex; align-items: center;">
        <div class="hero-content" style="max-width: 800px; padding: 100px 0;">
            <h1 style="font-size: 56px; font-weight: 800; color: white; margin-bottom: 20px; line-height: 1.2; text-shadow: 2px 2px 10px rgba(0, 0, 0, 0.3);">
                Our <span style="color: #66BB6A;">Purpose</span> &
                <span style="color: #66BB6A;">Aspiration</span>
            </h1>
            ...
            <div class="hero-stats" style="display: flex; gap: 30px; flex-wrap: wrap; margin-top: 40px;">
                <div class="stat" style="text-align: center;">
                    <div style="font-size: 36px; font-weight: 700; color: #66BB6A; margin-bottom: 5px;">1</div>
    ...
    <div class="container">
        <div class="mission-content" style="max-width: 900px; margin: 0 auto; position: relative; z-index: 2;">
            <div class="mission-header" style="text-align: center; margin-bottom: 60px;">
                <div class="mission-icon" style="width: 100px; height: 100px; background: #1B5E20; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 30px; color: white; font-size: 40px;">
                    <i class="fas fa-bullseye"></i>
                </div>
                <h2 style="font-size: 42px; color: #1B5E20; margin-bottom: 20px; font-weight: 800;">Our Mission</h2>
                <div class="mission-tagline" style="width: 80px; height: 4px; background: #66BB6A; margin: 0 auto; border-radius: 2px;"></div>
            </div>
            ...
            <div class="mission-card" style="background: #F8FAFC; border: 2px solid #E8F5E9; padding: 60px; border-radius: 30px; position: relative; overflow: hidden;">
                <div class="quote-icon" style="position: absolute; top: 30px; left: 40px; font-size: 80px; color: rgba(27, 94, 32, 0.1); font-family: serif;">"</div>

                <div class="mission-text" style="text-align: center; position: relative; z-index: 2;">
                    <p style="font-size: 28px; color: #1B5E20; line-height: 1.6; margin-bottom: 30px; font-style: italic; font-weight: 500;">
                    ...
                    <div class="mission-breakdown" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 30px; margin-top: 50px; padding-top: 50px; border-top: 1px solid #E8F5E9;">
                        <div class="breakdown-item" style="text-align: center;">
                            <div class="item-icon" style="width: 60px; height: 60px; background: rgba(27, 94, 32, 0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px; color: #1B5E20; font-size: 24px;">
                                <i class="fas fa-shield-alt"></i>
                            </div>
                            <h4 style="color: #1B5E20; margin-bottom: 10px; font-size: 18px;">Protection</h4>
                        ...
                        <div class="breakdown-item" style="text-align: center;">
                            ...
                            <h4 style="color: #1B5E20; margin-bottom: 10px; font-size: 18px;">Advocacy</h4>
                        ...
                        <div class="breakdown-item" style="text-align: center;">
                            ...
                            <h4 style="color: #1B5E20; margin-bottom: 10px; font-size: 18px;">Well-being</h4>
                            <p style="color: #666666; font-size: 14px; line-height: 1.6;">Ensuring dignity and quality of life for all workers</p>
                        </div>
                    </div>
                </div>

                <div class="quote-icon" style="position: absolute; bottom: 30px; right: 40px; font-size: 80px; color: rgba(27, 94, 32, 0.1); font-family: serif; transform: rotate(180deg);">"</div>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="vision-content" style="max-width: 900px; margin: 0 auto; position: relative; z-index: 2;">
            <div class="vision-header" style="text-align: center; margin-bottom: 60px;">
                <div class="vision-icon" style="width: 100px; height: 100px; background: #1B5E20; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 30px; color: white; font-size: 40px;">
                    <i class="fas fa-eye"></i>
                </div>
                <h2 style="font-size: 42px; color: #1B5E20; margin-bottom: 20px; font-weight: 800;">Our Vision</h2>
                <div class="vision-tagline" style="width: 80px; height: 4px; background: #66BB6A; margin: 0 auto; border-radius: 2px;"></div>
            </div>
            ...
            <div class="vision-card" style="background: white; border: 2px solid #E8F5E9; padding: 60px; border-radius: 30px; position: relative; overflow: hidden;">
                ...
                <div class="vision-text" style="text-align: center; position: relative; z-index: 2;">
                    <p style="font-size: 24px; color: #1B5E20; line-height: 1.6; margin-bottom: 30px; font-style: italic; font-weight: 500;">
                    ...
                    <div class="vision-pillars" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 25px; margin-top: 50px;">
                        <div class="pillar-item" style="text-align: center;">
                            <div class="pillar-number" style="width: 40px; height: 40px; background: #1B5E20; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px; color: white; font-weight: 700; font-size: 18px;">1</div>
                            <h4 style="color: #1B5E20; margin-bottom: 10px; font-size: 16px;">Solid Organization</h4>
                            <p style="color: #666666; font-size: 13px; line-height: 1.5;">Building institutional strength and capacity</p>
                        </div>

                        <div class="pillar-item" style="text-align: center;">
                            <div class="pillar-number" style="width: 40px; height: 40px; background: #2E7D32; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px; color: white; font-weight: 700; font-size: 18px;">2</div>
                            <h4 style="color: #1B5E20; margin-bottom: 10px; font-size: 16px;">Inclusive Alliances</h4>
                            <p style="color: #666666; font-size: 13px; line-height: 1.5;">Cross-cutting partnerships beyond divisions</p>
                        </div>

                        <div class="pillar-item" style="text-align: center;">
                            <div class="pillar-number" style="width: 40px; height: 40px; background: #4CAF50; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px; color: white; font-weight: 700; font-size: 18px;">3</div>
                            <h4 style="color: #1B5E20; margin-bottom: 10px; font-size: 16px;">Rights Advocacy</h4>
                            <p style="color: #666666; font-size: 13px; line-height: 1.5;">Claiming our rightful place in society</p>
                        </div>

                        <div class="pillar-item" style="text-align: center;">
                            <div class="pillar-number" style="width: 40px; height: 40px; background: #66BB6A; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px; color: white; font-weight: 700; font-size: 18px;">4</div>
                            <h4 style="color: #1B5E20; margin-bottom: 10px; font-size: 16px;">Holistic Development</h4>
...
<section class="core-values" style="padding: 100px 0; background: white;">
    <div class="container">
        ...
        <div class="values-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px;">
            <!-- Value 1 -->
            <div class="value-card" style="background: #F8FAFC; border-radius: 20px; padding: 40px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08); transition: all 0.4s ease; border-top: 4px solid #1B5E20;">
                <div class="value-header" style="display: flex; align-items: center; gap: 20px; margin-bottom: 25px;">
                    <div class="value-letter" style="width: 50px; height: 50px; background: #1B5E20; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 20px;">A</div>
                    <h3 style="color: #1B5E20; font-size: 22px; margin: 0;">Equality & Non-Discrimination</h3>
                </div>
                ...
                <div class="value-tags">
                    <span style="background: rgba(27, 94, 32, 0.1); color: #1B5E20; padding: 6px 12px; border-radius: 20px; font-size: 12px; font-weight: 500; margin-right: 8px;">
                        <i class="fas fa-equals"></i> Equal Opportunity
                    </span>
                    <span style="background: rgba(27, 94, 32, 0.1); color: #1B5E20; padding: 6px 12px; border-radius: 20px; font-size: 12px; font-weight: 500;">
            ...
            <div class="value-card" style="background: #F8FAFC; border-radius: 20px; padding: 40px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08); transition: all 0.4s ease; border-top: 4px solid #2E7D32;">
                <div class="value-header" style="display: flex; align-items: center; gap: 20px; margin-bottom: 25px;">
                    <div class="value-letter" style="width: 50px; height: 50px; background: #2E7D32; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 20px;">B</div>
                    <h3 style="color: #2E7D32; font-size: 22px; margin: 0;">Transformative Advocacy</h3>
                </div>
                <p style="color: #666666; line-height: 1.7; margin-bottom: 20px;">
            ...
            <div class="value-card" style="background: #F8FAFC; border-radius: 20px; padding: 40px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08); transition: all 0.4s ease; border-top: 4px solid #4CAF50;">
                <div class="value-header" style="display: flex; align-items: center; gap: 20px; margin-bottom: 25px;">
                    <div class="value-letter" style="width: 50px; height: 50px; background: #4CAF50; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 20px;">C</div>
                ...
                <div class="value-tags">
                    <span style="background: rgba(76, 175, 80, 0.2); color: #388E3C; padding: 6px 12px; border-radius: 20px; font-size: 12px; font-weight: 500; margin-right: 8px;">
                        <i class="fas fa-leaf"></i> Conservation
                    </span>
                    <span style="background: rgba(76, 175, 80, 0.2); color: #388E3C; padding: 6px 12px; border-radius: 20px; font-size: 12px; font-weight: 500;">
            ...
            <div class="value-card" style="background: #F8FAFC; border-radius: 20px; padding: 40px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08); transition: all 0.4s ease; border-top: 4px solid #81C784;">
                <div class="value-header" style="display: flex; align-items: center; gap: 20px; margin-bottom: 25px;">
                    <div class="value-letter" style="width: 50px; height: 50px; background: #81C784; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 20px;">E</div>
                    <h3 style="color: #388E3C; font-size: 22px; margin: 0;">Unity & Solidarity</h3>
                </div>
                <p style="color: #666666; line-height: 1.7; margin-bottom: 20px;">
                ...
                <div class="value-tags">
                    <span style="background: rgba(129, 199, 132, 0.1); color: #388E3C; padding: 6px 12px; border-radius: 20px; font-size: 12px; font-weight: 500; margin-right: 8px;">
                        <i class="fas fa-users"></i> Community
                    </span>
                    <span style="background: rgba(129, 199, 132, 0.1); color: #388E3C; padding: 6px 12px; border-radius: 20px; font-size: 12px; font-weight: 500;">
...
<section class="what-we-do" style="padding: 100px 0; background: #F8FAFC;">
    <div class="container">
        ...
        <div class="activities-timeline" style="position: relative; max-width: 800px; margin: 0 auto;">
            <div class="timeline-line" style="position: absolute; left: 30px; top: 0; bottom: 0; width: 3px; background: linear-gradient(to bottom, #1B5E20, #2E7D32, #4CAF50, #66BB6A, #81C784);"></div>
            ...
            <div class="activity-item" style="display: flex; gap: 30px; margin-bottom: 50px; position: relative;">
                <div class="activity-marker" style="width: 60px; flex-shrink: 0; text-align: center;">
                    <div class="marker-circle" style="width: 60px; height: 60px; background: #1B5E20; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 24px; position: relative; z-index: 2;">A</div>
                </div>
                <div class="activity-content" style="flex: 1; background: white; padding: 40px; border-radius: 20px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08); border-left: 4px solid #1B5E20;">
                    <h3 style="color: #1B5E20; margin-bottom: 15px; font-size: 24px;">Expansion & Membership Growth</h3>
                    <p style="color: #666666; line-height: 1.7; margin-bottom: 20px;">
            ...
            <div class="activity-item" style="display: flex; gap: 30px; margin-bottom: 50px; position: relative;">
                <div class="activity-marker" style="width: 60px; flex-shrink: 0; text-align: center;">
                    <div class="marker-circle" style="width: 60px; height: 60px; background: #2E7D32; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 24px; position: relative; z-index: 2;">B</div>
                </div>
                <div class="activity-content" style="flex: 1; background: white; padding: 40px; border-radius: 20px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08); border-left: 4px solid #2E7D32;">
                    <h3 style="color: #2E7D32; margin-bottom: 15px; font-size: 24px;">Education and Advocacy</h3>
                    <p style="color: #666666; line-height: 1.7; margin-bottom: 20px;">
            ...
            <div class="activity-item" style="display: flex; gap: 30px; margin-bottom: 50px; position: relative;">
                <div class="activity-marker" style="width: 60px; flex-shrink: 0; text-align: center;">
                    <div class="marker-circle" style="width: 60px; height: 60px; background: #4CAF50; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 24px; position: relative; z-index: 2;">C</div>
                </div>
            ...
            <div class="activity-item" style="display: flex; gap: 30px; position: relative;">
                <div class="activity-marker" style="width: 60px; flex-shrink: 0; text-align: center;">
                    <div class="marker-circle" style="width: 60px; height: 60px; background: #81C784; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 24px; position: relative; z-index: 2;">E</div>
                </div>
                <div class="activity-content" style="flex: 1; background: white; padding: 40px; border-radius: 20px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08); border-left: 4px solid #81C784;">
                    <h3 style="color: #388E3C; margin-bottom: 15px; font-size: 24px;">Struggle-Based Education</h3>
                    <p style="color: #666666; line-height: 1.7; margin-bottom: 20px;">
...
<!-- Call to Action -->
<section class="mission-cta" style="padding: 120px 0; background: linear-gradient(135deg, #1B5E20 0%, #2E7D32 100%); position: relative; overflow: hidden;">
