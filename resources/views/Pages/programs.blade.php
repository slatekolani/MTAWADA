    ...
    <div class="container" style="position: relative; z-index: 3; min-height: 500px; display: flex; align-items: center;">
        <div class="hero-content" style="max-width: 800px; padding: 100px 0;">
            <h1 style="font-size: 56px; font-weight: 800; color: white; margin-bottom: 20px; line-height: 1.2; text-shadow: 2px 2px 10px rgba(0, 0, 0, 0.3);">
                ...
                <span style="color: #FFC107;">Activities</span>
            </h1>
            ...
            <div class="hero-stats" style="display: flex; gap: 30px; flex-wrap: wrap; margin-top: 40px;">
                <div class="stat" style="text-align: center;">
                    <div style="font-size: 36px; font-weight: 700; color: #FFC107; margin-bottom: 5px;">4</div>
...
<section id="research" class="program-section" style="padding: 100px 0; background: white;">
    <div class="container">
        <div class="section-header" style="text-align: center; margin-bottom: 60px;">
            ...
            <h2 style="font-size: 42px; color: #2E7D32; margin-bottom: 20px; font-weight: 800;">Research</h2>
            <div class="program-tagline" style="width: 80px; height: 4px; background: #FFC107; margin: 0 auto; border-radius: 2px;"></div>
        ...
        <div class="research-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px;">
            <div class="research-card" style="background: #F8FAFC; border-radius: 20px; padding: 40px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08); border-left: 5px solid #2E7D32;">
                <div class="research-number" style="width: 50px; height: 50px; background: #2E7D32; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 20px; margin-bottom: 25px;">1</div>
                <h3 style="color: #2E7D32; margin-bottom: 15px; font-size: 22px;">Waste Management Studies</h3>
            ...
            <div class="research-card" style="background: #F8FAFC; border-radius: 20px; padding: 40px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08); border-left: 5px solid #4CAF50;">
                <div class="research-number" style="width: 50px; height: 50px; background: #4CAF50; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 20px; margin-bottom: 25px;">2</div>
                <h3 style="color: #4CAF50; margin-bottom: 15px; font-size: 22px;">Policy Analysis</h3>
                <p style="color: #666666; line-height: 1.7; margin-bottom: 20px;">
            ...
            <div class="research-card" style="background: #F8FAFC; border-radius: 20px; padding: 40px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08); border-left: 5px solid #81C784;">
                <div class="research-number" style="width: 50px; height: 50px; background: #81C784; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 20px; margin-bottom: 25px;">3</div>
                <h3 style="color: #388E3C; margin-bottom: 15px; font-size: 22px;">Livelihood Research</h3>
                <p style="color: #666666; line-height: 1.7; margin-bottom: 20px;">
...
<section id="resource-centre" class="program-section" style="padding: 100px 0; background: #F8FAFC;">
    <div class="container">
        <div class="section-header" style="text-align: center; margin-bottom: 60px;">
            ...
            <h2 style="font-size: 42px; color: #2E7D32; margin-bottom: 20px; font-weight: 800;">Resource Centre</h2>
            <div class="program-tagline" style="width: 80px; height: 4px; background: #FFC107; margin: 0 auto; border-radius: 2px;"></div>
            <p style="max-width: 800px; margin: 30px auto 0; font-size: 18px; color: #666666; line-height: 1.7;">
        ...
        {{-- <div class="resource-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 30px;">
            <div class="resource-card" style="background: white; border-radius: 15px; padding: 30px; text-align: center; box-shadow: 0 10px 20px rgba(0, 0, 0, 0.05);">
                ...
                <h4 style="color: #2E7D32; margin-bottom: 10px;">Policy Documents</h4>
            ...
            <div class="resource-card" style="background: white; border-radius: 15px; padding: 30px; text-align: center; box-shadow: 0 10px 20px rgba(0, 0, 0, 0.05);">
                ...
                <h4 style="color: #4CAF50; margin-bottom: 10px;">Training Manuals</h4>
                <p style="color: #666666; font-size: 14px;">Skills development and capacity building</p>
            </div>

            <div class="resource-card" style="background: white; border-radius: 15px; padding: 30px; text-align: center; box-shadow: 0 10px 20px rgba(0, 0, 0, 0.05);">
                <div class="resource-icon" style="width: 70px; height: 70px; background: rgba(129, 199, 132, 0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 25px; color: #388E3C; font-size: 30px;">
                    <i class="fas fa-chart-bar"></i>
                </div>
                <h4 style="color: #388E3C; margin-bottom: 10px;">Research Reports</h4>
                <p style="color: #666666; font-size: 14px;">Data and analysis on waste management</p>
            </div>

            <div class="resource-card" style="background: white; border-radius: 15px; padding: 30px; text-align: center; box-shadow: 0 10px 20px rgba(0, 0, 0, 0.05);">
                <div class="resource-icon" style="width: 70px; height: 70px; background: rgba(255, 193, 7, 0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 25px; color: #FF9800; font-size: 30px;">
                    <i class="fas fa-hands-helping"></i>
                </div>
                <h4 style="color: #FF9800; margin-bottom: 10px;">Advocacy Tools</h4>
...
<section id="news-events" class="program-section" style="padding: 100px 0; background: white;">
    <div class="container">
        <div class="section-header" style="text-align: center; margin-bottom: 60px;">
            <div class="program-icon" style="width: 100px; height: 100px; background: #81C784; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 30px; color: white; font-size: 40px;">
                <i class="fas fa-calendar-alt"></i>
            </div>
            <h2 style="font-size: 42px; color: #2E7D32; margin-bottom: 20px; font-weight: 800;">News & Events</h2>
            <div class="program-tagline" style="width: 80px; height: 4px; background: #FFC107; margin: 0 auto; border-radius: 2px;"></div>
            <p style="max-width: 800px; margin: 30px auto 0; font-size: 18px; color: #666666; line-height: 1.7;">
        ...
        {{-- <div class="events-timeline" style="max-width: 900px; margin: 0 auto;">
            <div class="event-item" style="background: #F8FAFC; border-radius: 20px; padding: 40px; margin-bottom: 30px; border-left: 5px solid #4CAF50;">
                <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 20px;">
                    ...
                    <div>
                        <h3 style="color: #2E7D32; margin-bottom: 5px; font-size: 24px;">Exchange Sessions</h3>
                        <p style="color: #666666; font-size: 16px;">Regular meetings where waste pickers share experiences and strategies</p>
                    </div>
                </div>
            </div>

            <div class="event-item" style="background: #F8FAFC; border-radius: 20px; padding: 40px; margin-bottom: 30px; border-left: 5px solid #81C784;">
                <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 20px;">
                    <div style="width: 60px; height: 60px; background: #81C784; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-size: 24px;">
                        <i class="fas fa-chalkboard-teacher"></i>
                    </div>
                    <div>
                        <h3 style="color: #2E7D32; margin-bottom: 5px; font-size: 24px;">Seminars & Conferences</h3>
                        <p style="color: #666666; font-size: 16px;">Educational events on waste management, rights, and circular economy</p>
                    </div>
                </div>
            </div>

            <div class="event-item" style="background: #F8FAFC; border-radius: 20px; padding: 40px; border-left: 5px solid #FF9800;">
                <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 20px;">
                    <div style="width: 60px; height: 60px; background: #FF9800; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-size: 24px;">
                        <i class="fas fa-calendar-day"></i>
                    </div>
                    <div>
                        <h3 style="color: #2E7D32; margin-bottom: 5px; font-size: 24px;">Commemorations</h3>
...
<!-- What We Do -->
<section id="what-we-do" class="program-section" style="padding: 100px 0; background: white;">
    <div class="container">
        <div class="section-header" style="text-align: center; margin-bottom: 60px;">
            ...
            <h2 style="font-size: 42px; color: #2E7D32; margin-bottom: 20px; font-weight: 800;">What We Do</h2>
            <div class="program-tagline" style="width: 80px; height: 4px; background: #FFC107; margin: 0 auto; border-radius: 2px;"></div>
            <p style="max-width: 800px; margin: 30px auto 0; font-size: 18px; color: #666666; line-height: 1.7;">
        ...
        <div class="activities-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px;">
            <div class="activity-card" style="background: #F8FAFC; border-radius: 20px; padding: 40px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08); border-top: 5px solid #2E7D32;">
                <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 25px;">
                    <div class="activity-letter" style="width: 50px; height: 50px; background: #2E7D32; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 20px;">A</div>
                    <h3 style="color: #2E7D32; font-size: 22px; margin: 0;">Expansion & Membership Growth</h3>
                </div>
                <p style="color: #666666; line-height: 1.7; margin-bottom: 20px;">
            ...
            <div class="activity-card" style="background: #F8FAFC; border-radius: 20px; padding: 40px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08); border-top: 5px solid #4CAF50;">
                <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 25px;">
                    <div class="activity-letter" style="width: 50px; height: 50px; background: #4CAF50; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 20px;">B</div>
                    <h3 style="color: #4CAF50; font-size: 22px; margin: 0;">Education and Advocacy</h3>
                </div>
                <p style="color: #666666; line-height: 1.7; margin-bottom: 20px;">
            ...
            <div class="activity-card" style="background: #F8FAFC; border-radius: 20px; padding: 40px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08); border-top: 5px solid #81C784;">
                <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 25px;">
                    <div class="activity-letter" style="width: 50px; height: 50px; background: #81C784; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 20px;">C</div>
                    <h3 style="color: #388E3C; font-size: 22px; margin: 0;">Support & Rights Protection</h3>
                </div>
                <p style="color: #666666; line-height: 1.7; margin-bottom: 20px;">
            ...
            <div class="activity-card" style="background: #F8FAFC; border-radius: 20px; padding: 40px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08); border-top: 5px solid #66BB6A;">
                <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 25px;">
                    ...
                    <h3 style="color: #2E7D32; font-size: 22px; margin: 0;">Advocacy & Voice Amplification</h3>
                </div>
                <p style="color: #666666; line-height: 1.7; margin-bottom: 20px;">
            ...
            <div class="activity-card" style="background: #F8FAFC; border-radius: 20px; padding: 40px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08); border-top: 5px solid #FF9800;">
                <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 25px;">
                    <div class="activity-letter" style="width: 50px; height: 50px; background: #FF9800; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 20px;">E</div>
                    <h3 style="color: #FF9800; font-size: 22px; margin: 0;">Struggle-Based Education</h3>
                </div>
                <p style="color: #666666; line-height: 1.7; margin-bottom: 20px;">
...
<!-- Call to Action -->
<section class="programs-cta" style="padding: 120px 0; background: linear-gradient(135deg, #2E7D32 0%, #4CAF50 100%); position: relative; overflow: hidden;">
