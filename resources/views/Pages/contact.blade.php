...
@section('content')
<!-- Hero Section -->
<section class="contact-hero" style="margin-top: 90px; position: relative; overflow: hidden; background: linear-gradient(135deg, #2E7D32 0%, #4CAF50 100%);">
    <div class="hero-bg" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;">
        ...
        <div class="floating-phone" style="position: absolute; top: 20%; left: 10%; font-size: 50px; opacity: 0.2; color: #FFC107; animation: float 15s infinite ease-in-out;">📞</div>
        <div class="floating-email" style="position: absolute; bottom: 30%; right: 15%; font-size: 60px; opacity: 0.2; color: #FFC107; animation: float 20s infinite ease-in-out reverse;">✉️</div>
        <div class="floating-location" style="position: absolute; top: 40%; right: 20%; font-size: 45px; opacity: 0.2; color: #FFC107; animation: float 18s infinite ease-in-out;">📍</div>
    </div>
        ...
        <div class="hero-content" style="max-width: 800px; padding: 100px 0;">
            ...
            <div class="hero-stats" style="display: flex; gap: 40px; flex-wrap: wrap; margin-top: 40px;">
                <div class="stat" style="text-align: center; background: rgba(255, 255, 255, 0.15); padding: 20px; border-radius: 15px; backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.2);">
                    <div style="font-size: 36px; font-weight: 700; color: #FFC107; margin-bottom: 5px;">
    ...
    <div class="container">
        ...
        <div class="contact-methods" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px;">
            ...
            <div class="contact-card" style="background: #F8FAFC; border-radius: 20px; padding: 40px; text-align: center; box-shadow: 0 15px 30px rgba(0, 0, 0, 0.05); transition: all 0.3s ease; border-top: 5px solid #2E7D32;">
                ...
                <h3 style="color: #2E7D32; margin-bottom: 15px; font-size: 22px;">Call Us</h3>
                ...
                <div class="contact-details">
                    <div style="font-size: 24px; font-weight: 700; color: #2E7D32; margin-bottom: 10px;">
                ...
                <div style="margin-top: 30px;">
                    <a href="tel:+255793543206" style="display: inline-flex; align-items: center; gap: 10px; background: #2E7D32; color: white; padding: 12px 30px; border-radius: 30px; text-decoration: none; font-weight: 600; transition: all 0.3s;">
            ...
            <div class="contact-card" style="background: #F8FAFC; border-radius: 20px; padding: 40px; text-align: center; box-shadow: 0 15px 30px rgba(0, 0, 0, 0.05); transition: all 0.3s ease; border-top: 5px solid #4CAF50;">
                ...
                <h3 style="color: #4CAF50; margin-bottom: 15px; font-size: 22px;">Email Us</h3>
                ...
                <div class="contact-details">
                    <div style="font-size: 18px; font-weight: 600; color: #4CAF50; margin-bottom: 10px;">
                ...
                <div style="margin-top: 30px;">
                    <a href="#contact-form" style="display: inline-flex; align-items: center; gap: 10px; background: #4CAF50; color: white; padding: 12px 30px; border-radius: 30px; text-decoration: none; font-weight: 600; transition: all 0.3s;">
            ...
            <!-- Visit -->
            <div class="contact-card" style="background: #F8FAFC; border-radius: 20px; padding: 40px; text-align: center; box-shadow: 0 15px 30px rgba(0, 0, 0, 0.05); transition: all 0.3s ease; border-top: 5px solid #FF9800;">
                <div class="contact-icon" style="width: 80px; height: 80px; background: rgba(255, 152, 0, 0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 30px; color: #FF9800; font-size: 36px;">
                    <i class="fas fa-map-marker-alt"></i>
                </div>

                <h3 style="color: #FF9800; margin-bottom: 15px; font-size: 22px;">Visit Us</h3>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 50px; background: white; border-radius: 20px; overflow: hidden; box-shadow: 0 20px 60px rgba(0, 0, 0, 0.1);">
                ...
                <div class="form-side" style="padding: 50px;">
                    <div class="form-header" style="margin-bottom: 40px;">
                        <h2 style="color: #2E7D32; font-size: 32px; margin-bottom: 10px;">Send Us a Message</h2>
                    ...
                    <form id="contactForm" style="display: grid; gap: 20px;">
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div class="form-group">
                                <label style="display: block; color: #2E7D32; font-weight: 600; margin-bottom: 8px; font-size: 14px;">
                                    First Name <span style="color: #FF9800;">*</span>
                                </label>
                            ...
                            <div class="form-group">
                                <label style="display: block; color: #2E7D32; font-weight: 600; margin-bottom: 8px; font-size: 14px;">
                                    Last Name <span style="color: #FF9800;">*</span>
                                </label>
                                <input type="text" required style="width: 100%; padding: 12px 15px; border: 2px solid #ddd; border-radius: 10px; font-size: 16px; transition: all 0.3s; outline: none;">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label style="display: block; color: #2E7D32; font-weight: 600; margin-bottom: 8px; font-size: 14px;">
                                Email Address <span style="color: #FF9800;">*</span>
                            </label>
                        ...
                        <div class="form-group">
                            <label style="display: block; color: #2E7D32; font-weight: 600; margin-bottom: 8px; font-size: 14px;">
                                Inquiry Type <span style="color: #FF9800;">*</span>
                            </label>
                        ...
                        <div class="form-group">
                            <label style="display: block; color: #2E7D32; font-weight: 600; margin-bottom: 8px; font-size: 14px;">
                                Message <span style="color: #FF9800;">*</span>
                            </label>
                        ...
                        <button type="submit" style="background: #2E7D32; color: white; padding: 15px 30px; border: none; border-radius: 10px; font-size: 16px; font-weight: 600; cursor: pointer; transition: all 0.3s; display: flex; align-items: center; justify-content: center; gap: 10px;">
                ...
                <!-- Info Side -->
                <div class="info-side" style="background: linear-gradient(135deg, #2E7D32 0%, #4CAF50 100%); padding: 50px; color: white;">
                    <div class="info-content" style="height: 100%; display: flex; flex-direction: column; justify-content: center;">
                        ...
                        <div class="emergency-contact" style="background: rgba(255, 255, 255, 0.1); padding: 20px; border-radius: 10px; border-left: 4px solid #FFC107;">
                            ...
                            <p style="font-size: 14px; opacity: 0.9; margin: 0;">
                                ...
                                <a href="tel:+255793543206" style="color: #FFC107; font-weight: 600; text-decoration: none;">+255 793 543 206</a>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="location-grid" style="display: row; grid-template-columns: 2fr 2fr; gap: 50px; margin-bottom: 50px;">
            ...
            <div class="office-details" style="background: #F8FAFC; border-radius: 15px; padding: 40px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08);">
                <h3 style="color: #2E7D32; margin-bottom: 30px; font-size: 24px; display: flex; align-items: center; gap: 15px;">
                    <i class="fas fa-building"></i> Headquarters
                </h3>

                <div class="address" style="margin-bottom: 30px;">
                    <h4 style="color: #4CAF50; margin-bottom: 15px; font-size: 18px; display: flex; align-items: center; gap: 10px;">
                ...
                <div class="office-hours" style="margin-bottom: 30px;">
                    ...
                    <div style="display: grid; gap: 10px;">
                        <div style="display: flex; justify-content: space-between; padding-bottom: 10px; border-bottom: 1px solid #eee;">
                            ...
                            <span style="color: #2E7D32; font-weight: 600;">8:00 AM - 5:00 PM</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; padding-bottom: 10px; border-bottom: 1px solid #eee;">
                            <span style="color: #666666;">Saturday</span>
                            <span style="color: #2E7D32; font-weight: 600;">9:00 AM - 1:00 PM</span>
                        </div>
                        <div style="display: flex; justify-content: space-between;">
                            <span style="color: #666666;">Sunday</span>
                            <span style="color: #FF9800; font-weight: 600;">Closed</span>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="faq-grid" style="max-width: 800px; margin: 0 auto;">
            ...
            <div class="faq-item" style="background: white; border-radius: 15px; margin-bottom: 20px; overflow: hidden; box-shadow: 0 5px 15px rgba(0, 0, 0, 0.05);">
                <button class="faq-question" style="width: 100%; padding: 25px; text-align: left; background: none; border: none; cursor: pointer; display: flex; justify-content: space-between; align-items: center; font-size: 18px; color: #2E7D32; font-weight: 600;">
